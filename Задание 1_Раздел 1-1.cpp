...
int main()
{
	...
	if (isLocedDoor)
	{
		...
		while (true)
			...
			cin >> b;
				if (b == 1)
				{
					cout << "Упс, злая собака. Нужно срочно закрыть дверь! \n";
					continue;
				}
				else if ((b > 2) || (b < 1))
				{
					cout << "А что же в комнате? Давайте зайдём. \n";
					continue;
				}
	...
	else cout << "Дверь заперта. Без кода её не открыть. \n\n";
